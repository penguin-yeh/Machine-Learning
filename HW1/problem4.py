...
def pocket(dataset, updates=10000):
    w = np.zeros(3)
...
def main():
    ...
    accurate_rate_mis = (2000-sum_errors(w_mis, cor_dataset))/2000
    #print(sum_errors(w_cor, cor_dataset))
    #print(sum_errors(w_mis, cor_dataset))
    print('accurate rate of correct dataset: %.2f' % accurate_rate_cor)
    print('accurate rate of mislabelled dataset: %.2f' % accurate_rate_mis)
